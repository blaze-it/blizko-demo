	...
	(
		...
		const setOpen = React.useCallback(
			(value: boolean | ((value: boolean) => boolean)) => {
				...
				// biome-ignore lint/suspicious/noDocumentCookie: Cookie Store API not fully supported
				...
				>
					<div
						...
						className={cn(
							...
							'bg-sidebar',
							'backdrop-blur-xl',
							// Floating variant enhancements
							'group-data-[variant=floating]:rounded-2xl',
							'group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border/60',
					...
					>
						...
						{/* Side accent */}
						<div className="absolute top-16 bottom-16 right-0 w-px bg-gradient-to-b from-transparent via-primary/15 to-transparent" />
	...
	return (
		<button
			...
			className={cn(
				...
				'after:absolute after:inset-y-8 after:left-1/2 after:w-[2px] after:rounded-full',
...
>(({ className, ...props }, ref) => {
	return (
		<div
			...
			data-sidebar="header"
			className={cn(
				'relative flex flex-col gap-2 p-4 pb-3',
				// Bottom border with gradient fade
				'after:absolute after:bottom-0 after:left-4 after:right-4 after:h-px',
				'after:bg-gradient-to-r after:from-transparent after:via-sidebar-border/80 after:to-transparent',
				className,
			)}
			{...props}
		/>
...
>(({ className, ...props }, ref) => {
	return (
		<div
			...
			data-sidebar="footer"
			className={cn(
				'relative flex flex-col gap-2 p-3 pt-2',
				// Top border with gradient fade
				'before:absolute before:top-0 before:left-4 before:right-4 before:h-px',
				'before:bg-gradient-to-r before:from-transparent before:via-sidebar-border/80 before:to-transparent',
	...
	return (
		<div
			...
			className={cn(
				...
				// Custom scrollbar styling - uses scrollbar-thin utility which respects theme
				'scrollbar-thin',
	...
	return (
		<Comp
			...
			className={cn(
				...
				'font-["Cormorant_Garamond",serif] text-[11px] font-semibold uppercase tracking-[0.2em]',
				'text-primary',
				// Subtle decorative line
				'relative',
				'after:absolute after:left-3 after:right-3 after:bottom-0 after:h-px',
				'after:bg-gradient-to-r after:from-primary/20 after:via-primary/8 after:to-transparent',
				// Transitions and focus
				'outline-none ring-sidebar-ring transition-all duration-300 ease-out',
...
const sidebarMenuButtonVariants = cva(
	[
		// Base layout
		'peer/menu-button relative flex w-full items-center gap-3 overflow-hidden rounded-xl p-2.5 text-left outline-none',
		// Typography
		...
		// Collapsed state
		'group-data-[collapsible=icon]:!size-10 group-data-[collapsible=icon]:!p-2.5 group-data-[collapsible=icon]:!rounded-xl',
		// Icon and text styling
		'[&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0',
		// Active state - theme-aware primary glow
		...
		'data-[active=true]:before:-translate-y-1/2 data-[active=true]:before:w-[3px] data-[active=true]:before:h-5',
	...
	].join(' '),
	{
		variants: {
			variant: {
				...
				outline: [
					'bg-transparent ring-1 ring-sidebar-border/60',
